    ...
    <div id="page">
        ...
        <div id="main-wrapper">
            <div class="goods-list tab2 ">
                <div class="left-side">
                    <div class="term_tree category_goods">
                        <?php echo tax_tree_taxonomy_tree('goods_category'); ?>
                    </div>
                </div>
                <div class="right-side">
                    <div class="company_tags">
                        <?php echo tax_tree_taxonomy_tree('goods_tags'); ?>
                    </div>
                    <div class="goods-list">
                        <?php
                        print views_embed_view('all_goods', 'page_1');
                        ?>
                    </div>
                </div>
            </div>
